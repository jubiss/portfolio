...
real_estate_scraper = html.Div([
    ...
    html.P(["You can find the project ", html.A(href="https://github.com/jubiss/real_estate_crawler",
            children="here",
            target="_blank"),])
])

dash_personal_web = html.Div([
    html.H3("Dash Portfolio"),
    ...
    html.P(["You can find the project ", html.A(href="https://github.com/jubiss/portfolio",
            children="here",
            target="_blank"),])
])

dash_components = html.Div([
    html.H3("Dash custom components"),
...
dash_template = html.Div([
    html.H3("Dash Multipage Template"),
    html.P("""
